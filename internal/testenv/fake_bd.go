// RunFakeBD implements the bd process double for command entrypoints and re-executed test binaries.
package testenv
...
func RunFakeBD() {
	if err := Record(os.Getenv("MAGICITE_TRACE"), os.Args, workingDirectory()); err != nil {
